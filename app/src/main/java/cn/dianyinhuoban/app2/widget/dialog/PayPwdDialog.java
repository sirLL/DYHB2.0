...
//            Intent intent = new Intent(getContext(), BankPassActivity.class);
//            intent.putExtra("header", "设置支付密码");
...
//        });
    ...
    @Override
    public void inputCodeComplete(String password) {
//        dismiss();
        if (onInputCodeListener != null) {
            onInputCodeListener.inputCodeComplete(this, password);
        }
    }

    @Override
    public void inputCodeInput(String password) {
        if (onInputCodeListener != null) {
            onInputCodeListener.inputCodeInput(this, password);
        }
    }
    ...
    public interface OnInputCodeListener {
         ...
         * @param password
         */
        void inputCodeComplete(Dialog dialog, String password);
         ...
         * @param password
         */
        void inputCodeInput(Dialog dialog, String password);
    }
}
